...
target_sources(${PROJECT_NAME} PRIVATE
    ...
    # STM32 HAL driver (minimal set: RCC/GPIO/DMA/EXTI/FLASH/PWR/CORTEX/I2C)
    ...
    # SSD1306 OLED driver (vendored third-party library, MIT licensed --
    # see Middlewares/SSD1306/LICENSE-ssd1306.txt)
    "${CMAKE_CURRENT_SOURCE_DIR}/Middlewares/SSD1306/ssd1306.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/Middlewares/SSD1306/ssd1306_fonts.c"
)
...
target_include_directories(${PROJECT_NAME} PRIVATE
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/Middlewares/SSD1306"
)
